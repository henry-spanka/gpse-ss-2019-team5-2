...
public class InitializeDefaultMeetings {
    ...
    public void init() {
        ...
        meeting1.setStartAt(LocalDateTime.of(2019, 5, 20, 10, 15));
        meeting1.setEndAt(LocalDateTime.of(2019, 5, 20, 11, 45));
        ...
        meeting2.setStartAt(LocalDateTime.of(2019, 5, 20, 14, 0));
        meeting2.setEndAt(LocalDateTime.of(2019, 5, 20, 15, 0));
        ...
        meeting3.setStartAt(LocalDateTime.of(2019, 5, 21, 23, 0));
        meeting3.setEndAt(LocalDateTime.of(2019, 5, 21, 23, 30));
